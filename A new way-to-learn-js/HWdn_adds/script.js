...
// }
{
  ...
  function getRandomPassword(passLength) {
    ...
    let passwordArr = [];
    let getSymbType = () => getRandomInt(rangeArray.length);
    let getSymb = () => getRandomInt(rangeArray[getSymbType()].length);
    ...
    function fillPasswordArr(passLength) {
      const randvalue = getSymbType();
      const secrandvalue = getSymb();
      console.log(randvalue);
      console.log(secrandvalue + "__");
      passwordArr.push(rangeArray[randvalue][secrandvalue]);
      if (passwordArr.length !== passLength) {
        fillPasswordArr(passLength);
      } else {
        return passwordArr;
      }
  ...
  console.log(getRandomPassword(8));
    ...
    // minConditions(passLength);
    // function minConditions(passLength) {
    // }