{
  ...
  function reverseString(str) {// arr - исходный массив
...
}
{
  ...
  function uniqueValues1(arr) {// arr - исходный массив
...
}
{
  ...
  function intersection(arr1, arr2) {// arr1 и arr2 - исходные массивы
    return Array.from(
...
}
{
  ...
  function contains(arr, value) {// arr - проверяемый массив, value - проверяемое значение
...
}
{
  ...
  // (0 °C × 9/5) + 32 = 32 °F
  function celsiusToFahrenheit(celsius) { // celsius - значение в градусах
